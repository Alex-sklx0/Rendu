...
- Frontend: conexion de LoginPage y RegistroPersonaPage con selector de municipio y rol dinamico.
...
- Frontend: RegistroEmpresaPage con selector desplegable de municipios del Valle de Aburra y rol empresarial."
...
- client.ts conectado 100% a la API REST del backend con soporte de mis-publicaciones por usuario/empresa.
